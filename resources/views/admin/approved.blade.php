...
<main id="main" class="main">
    <div class="content-wrapper">
        <div class="top-bar">
            ...
            <a href="/admin/schedule" class="approved-link">
                <i class="bi bi-eye"></i> Live Requests
            </a>
        </div>
    ...
    function fetchApprovedSchedules() {
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.length === 0) {
                    tableBody.append(`<tr><td colspan="6" style="text-align:center;">No approved requests found.</td></tr>`);
                } else {
