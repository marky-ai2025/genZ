...
document.addEventListener("DOMContentLoaded", function () {
  setTimeout(function () {
      ...
      alerts.forEach((alert) => {
          ...
          setTimeout(() => {
              alert.remove(); // Completely remove from DOM after fading out
...
var map = L.map('map').setView([16.6793, 121.5456], 17); // Adjust zoom if needed
...
// Add a marker for SIMC
L.marker([16.6793, 121.5456]).addTo(map)
    .bindPopup("<b>Southern Isabela Medical Center</b><br>Santiago City, Isabela.")
    .openPopup();
